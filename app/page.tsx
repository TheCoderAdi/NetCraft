...
export default function Home() {
  return (
    <>
      <div className="flex flex-col items-center justify-center min-h-screen p-8 text-black font-sans ">
        <h1 className="text-5xl font-extrabold text-gray-900 tracking-tight leading-tight mb-6 max-sm:text-center max-sm:text-3xl">
          Discover <span className="text-purple-500">Network Topologies</span>
        </h1>

        <p className="text-lg max-w-2xl text-center text-gray-700 mb-8 max-sm:text-base">
        ...
        <div className="bg-white p-6 shadow-lg rounded-lg w-full max-w-xl">
          <h2 className="text-2xl font-bold text-gray-800 mb-4 max-sm:text-lg">
        ...
        <Link href={"/visualiser"}>
          <button
            className={`${buttonVariants({
              variant: "default",
            })} mt-8 w-40 h-14 rounded-full p-20 `}
          >
            Visualize Now
          </button>
        </Link>
